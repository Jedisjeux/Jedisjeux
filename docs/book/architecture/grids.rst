...
.. note::
   ...
   The way Grids are used in Jedisjeux is well described in the `GridBundle documentation <http://docs.sylius.org/en/latest/components_and_bundles/bundles/SyliusGridBundle/index.html?highlight=Grid>`_.
