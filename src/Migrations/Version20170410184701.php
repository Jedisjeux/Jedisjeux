 ...
 */
class Version20170410184701 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sylius_product (id INT AUTO_INCREMENT NOT NULL, main_taxon_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, available_on DATETIME DEFAULT NULL, available_until DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, enabled TINYINT(1) NOT NULL, status VARCHAR(255) NOT NULL, age_min INT UNSIGNED DEFAULT NULL, joueur_min INT UNSIGNED DEFAULT NULL, joueur_max INT UNSIGNED DEFAULT NULL, duration_min INT UNSIGNED DEFAULT NULL, duration_max INT UNSIGNED DEFAULT NULL, duration_by_player TINYINT(1) NOT NULL, materiel LONGTEXT DEFAULT NULL, but LONGTEXT DEFAULT NULL, view_count INT NOT NULL, average_rating DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_677B9B7477153098 (code), INDEX IDX_677B9B74731E505 (main_taxon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jdj_article (id INT AUTO_INCREMENT NOT NULL, main_image_id INT DEFAULT NULL, slide_show_block_id INT DEFAULT NULL, topic_id INT DEFAULT NULL, main_taxon_id INT DEFAULT NULL, product_id INT DEFAULT NULL, author_id INT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, publish_start_date DATETIME DEFAULT NULL, short_description LONGTEXT DEFAULT NULL, publish_end_date DATETIME DEFAULT NULL, publishable TINYINT(1) NOT NULL, status VARCHAR(255) NOT NULL, image_path VARCHAR(255) DEFAULT NULL, view_count INT NOT NULL, average_rating DOUBLE PRECISION NOT NULL, material_rating DOUBLE PRECISION NOT NULL, rules_rating DOUBLE PRECISION NOT NULL, lifetime_rating DOUBLE PRECISION NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_DBEDE01277153098 (code), UNIQUE INDEX UNIQ_DBEDE012989D9B62 (slug), UNIQUE INDEX UNIQ_DBEDE012E4873418 (main_image_id), UNIQUE INDEX UNIQ_DBEDE012DA5AEC1B (slide_show_block_id), UNIQUE INDEX UNIQ_DBEDE0121F55203D (topic_id), INDEX IDX_DBEDE012731E505 (main_taxon_id), INDEX IDX_DBEDE0124584665A (product_id), INDEX IDX_DBEDE012F675F31B (author_id), INDEX publishable_idx (publishable), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_article_image (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_article_review (id INT AUTO_INCREMENT NOT NULL, review_subject_id INT DEFAULT NULL, author_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, rating INT NOT NULL, comment LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_4764CDD675AE1D8A (review_subject_id), INDEX IDX_4764CDD6F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_customer_avatar (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_block (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, article_id INT DEFAULT NULL, slide_show_block_id INT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, body LONGTEXT DEFAULT NULL, image_position VARCHAR(255) DEFAULT NULL, class VARCHAR(255) DEFAULT NULL, position INT NOT NULL, UNIQUE INDEX UNIQ_ECC2786377153098 (code), UNIQUE INDEX UNIQ_ECC278633DA5256D (image_id), INDEX IDX_ECC278637294869C (article_id), INDEX IDX_ECC27863DA5AEC1B (slide_show_block_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_block_image (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, `label` VARCHAR(255) DEFAULT NULL, link_url VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_contact_request (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jdj_dealer_image (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_dealer_price (id INT AUTO_INCREMENT NOT NULL, dealer_id INT DEFAULT NULL, product_id INT DEFAULT NULL, url VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, barcode VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_5709B40F47645AE (url), INDEX IDX_5709B40249E6EA1 (dealer_id), INDEX IDX_5709B404584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_person (id INT AUTO_INCREMENT NOT NULL, last_name VARCHAR(50) NOT NULL, first_name VARCHAR(50) NOT NULL, website VARCHAR(200) DEFAULT NULL, description LONGTEXT DEFAULT NULL, slug VARCHAR(128) NOT NULL, product_count_as_designer INT NOT NULL, product_count_as_artist INT NOT NULL, product_count_as_publisher INT NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_3568799F989D9B62 (slug), INDEX search_idx (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jdj_person_image (id INT AUTO_INCREMENT NOT NULL, person_id INT DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, is_main TINYINT(1) NOT NULL, INDEX IDX_8BC5367C217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jdj_product_list (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, code VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_2BEEF75E989D9B62 (slug), INDEX IDX_2BEEF75E7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_product_list_item (id INT AUTO_INCREMENT NOT NULL, list_id INT DEFAULT NULL, product_id INT DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_BA00A723DAE168B (list_id), INDEX IDX_BA00A724584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_pub_banner (id INT AUTO_INCREMENT NOT NULL, dealer_id INT DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, target_url VARCHAR(255) NOT NULL, INDEX IDX_BD4915E8249E6EA1 (dealer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jdj_game_play (id INT AUTO_INCREMENT NOT NULL, topic_id INT DEFAULT NULL, product_id INT NOT NULL, author_id INT NOT NULL, code VARCHAR(255) DEFAULT NULL, duration INT UNSIGNED DEFAULT NULL, player_count INT DEFAULT NULL, played_at DATE DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_B97D18CC77153098 (code), UNIQUE INDEX UNIQ_B97D18CC1F55203D (topic_id), INDEX IDX_B97D18CC4584665A (product_id), INDEX IDX_B97D18CCF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_game_play_image (id INT AUTO_INCREMENT NOT NULL, game_play_id INT DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_2A655791B0951292 (game_play_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_player (id INT AUTO_INCREMENT NOT NULL, game_play_id INT NOT NULL, customer_id INT DEFAULT NULL, score DOUBLE PRECISION DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, INDEX IDX_99ADD28CB0951292 (game_play_id), INDEX IDX_99ADD28C9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jdj_notification (id INT AUTO_INCREMENT NOT NULL, topic_id INT DEFAULT NULL, article_id INT DEFAULT NULL, recipient_id INT NOT NULL, product_id INT DEFAULT NULL, is_read TINYINT(1) NOT NULL, message LONGTEXT NOT NULL, target VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_5D9A5B2D1F55203D (topic_id), INDEX IDX_5D9A5B2D7294869C (article_id), INDEX IDX_5D9A5B2DE92F8F78 (recipient_id), INDEX IDX_5D9A5B2D4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jdj_topic (id INT AUTO_INCREMENT NOT NULL, main_post_id INT DEFAULT NULL, author_id INT NOT NULL, main_taxon_id INT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, post_count INT NOT NULL, view_count INT NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_F299315A77153098 (code), UNIQUE INDEX UNIQ_F299315ABFC2AAC5 (main_post_id), INDEX IDX_F299315AF675F31B (author_id), INDEX IDX_F299315A731E505 (main_taxon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jdj_post (id INT AUTO_INCREMENT NOT NULL, topic_id INT DEFAULT NULL, game_play_id INT DEFAULT NULL, article_id INT DEFAULT NULL, reply_to_id INT DEFAULT NULL, author_id INT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, body LONGTEXT NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_3312CC5B77153098 (code), INDEX IDX_3312CC5B1F55203D (topic_id), INDEX IDX_3312CC5BB0951292 (game_play_id), INDEX IDX_3312CC5B7294869C (article_id), INDEX IDX_3312CC5BFFDF7169 (reply_to_id), INDEX IDX_3312CC5BF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_product_variant_image (id INT AUTO_INCREMENT NOT NULL, variant_id INT DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, is_main TINYINT(1) NOT NULL, is_material TINYINT(1) NOT NULL, INDEX IDX_C6B77D5D3B69A9AF (variant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_taxon (id INT AUTO_INCREMENT NOT NULL, tree_root INT DEFAULT NULL, parent_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, tree_left INT NOT NULL, tree_right INT NOT NULL, tree_level INT NOT NULL, position INT NOT NULL, icon_class VARCHAR(255) DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, public TINYINT(1) NOT NULL, topic_count INT NOT NULL, product_count INT NOT NULL, UNIQUE INDEX UNIQ_CFD811CA77153098 (code), INDEX IDX_CFD811CAA977936C (tree_root), INDEX IDX_CFD811CA727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sylius_product_taxon ADD CONSTRAINT FK_169C6CD97E2DD0E0 FOREIGN KEY (taxoninterface_id) REFERENCES sylius_taxon (id)');
        ...
        $this->addSql('ALTER TABLE jdj_designer_product_variant ADD CONSTRAINT FK_B5D320D01855BE3F FOREIGN KEY (productvariant_id) REFERENCES sylius_product_variant (id)');
        $this->addSql('ALTER TABLE jdj_designer_product_variant ADD CONSTRAINT FK_B5D320D0217BBB47 FOREIGN KEY (person_id) REFERENCES jdj_person (id)');
        $this->addSql('ALTER TABLE jdj_artist_product_variant ADD CONSTRAINT FK_DD0291E91855BE3F FOREIGN KEY (productvariant_id) REFERENCES sylius_product_variant (id)');
        $this->addSql('ALTER TABLE jdj_artist_product_variant ADD CONSTRAINT FK_DD0291E9217BBB47 FOREIGN KEY (person_id) REFERENCES jdj_person (id)');
        $this->addSql('ALTER TABLE jdj_publisher_product_variant ADD CONSTRAINT FK_F4ABCB1B1855BE3F FOREIGN KEY (productvariant_id) REFERENCES sylius_product_variant (id)');
        $this->addSql('ALTER TABLE jdj_publisher_product_variant ADD CONSTRAINT FK_F4ABCB1B217BBB47 FOREIGN KEY (person_id) REFERENCES jdj_person (id)');
        ...
        $this->addSql('ALTER TABLE jdj_article ADD CONSTRAINT FK_DBEDE012E4873418 FOREIGN KEY (main_image_id) REFERENCES jdj_article_image (id)');
        $this->addSql('ALTER TABLE jdj_article ADD CONSTRAINT FK_DBEDE012DA5AEC1B FOREIGN KEY (slide_show_block_id) REFERENCES jdj_slideshow_block (id)');
        ...
        $this->addSql('ALTER TABLE jdj_article ADD CONSTRAINT FK_DBEDE012731E505 FOREIGN KEY (main_taxon_id) REFERENCES sylius_taxon (id)');
        ...
        $this->addSql('ALTER TABLE jdj_block ADD CONSTRAINT FK_ECC27863DA5AEC1B FOREIGN KEY (slide_show_block_id) REFERENCES jdj_slideshow_block (id)');
        ...
        $this->addSql('ALTER TABLE jdj_person_taxon ADD CONSTRAINT FK_159F11887E2DD0E0 FOREIGN KEY (taxoninterface_id) REFERENCES sylius_taxon (id)');
        ...
        $this->addSql('ALTER TABLE jdj_game_play_image ADD CONSTRAINT FK_2A655791B0951292 FOREIGN KEY (game_play_id) REFERENCES jdj_game_play (id)');
        $this->addSql('ALTER TABLE jdj_player ADD CONSTRAINT FK_99ADD28CB0951292 FOREIGN KEY (game_play_id) REFERENCES jdj_game_play (id)');
        ...
        $this->addSql('ALTER TABLE jdj_topic ADD CONSTRAINT FK_F299315ABFC2AAC5 FOREIGN KEY (main_post_id) REFERENCES jdj_post (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE jdj_topic ADD CONSTRAINT FK_F299315AF675F31B FOREIGN KEY (author_id) REFERENCES sylius_customer (id)');
        $this->addSql('ALTER TABLE jdj_topic ADD CONSTRAINT FK_F299315A731E505 FOREIGN KEY (main_taxon_id) REFERENCES sylius_taxon (id)');
        ...
        $this->addSql('ALTER TABLE jdj_topic_follower ADD CONSTRAINT FK_1B075FD0F6FD7074 FOREIGN KEY (customerinterface_id) REFERENCES sylius_customer (id)');
        ...
        $this->addSql('ALTER TABLE jdj_post ADD CONSTRAINT FK_3312CC5BFFDF7169 FOREIGN KEY (reply_to_id) REFERENCES jdj_post (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jdj_article DROP FOREIGN KEY FK_DBEDE012E4873418');
        ...
        $this->addSql('ALTER TABLE jdj_article DROP FOREIGN KEY FK_DBEDE012DA5AEC1B');
        $this->addSql('ALTER TABLE jdj_block DROP FOREIGN KEY FK_ECC27863DA5AEC1B');
        $this->addSql('ALTER TABLE jdj_game_play_image DROP FOREIGN KEY FK_2A655791B0951292');
        $this->addSql('ALTER TABLE jdj_player DROP FOREIGN KEY FK_99ADD28CB0951292');
        ...
        $this->addSql('ALTER TABLE jdj_topic DROP FOREIGN KEY FK_F299315ABFC2AAC5');
        $this->addSql('ALTER TABLE jdj_post DROP FOREIGN KEY FK_3312CC5BFFDF7169');
        ...
        $this->addSql('ALTER TABLE jdj_article DROP FOREIGN KEY FK_DBEDE012731E505');
        $this->addSql('ALTER TABLE jdj_person_taxon DROP FOREIGN KEY FK_159F11887E2DD0E0');
        $this->addSql('ALTER TABLE jdj_topic DROP FOREIGN KEY FK_F299315A731E505');
