 ...
 */
class Version20180726145549 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jdj_person CHANGE code code VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
