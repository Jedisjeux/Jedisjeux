...
class ProductNotificationManager
{
    ...
    public function notifyTranslators(ProductInterface $product)
    {
        ...
        $this->notifyUsers($this->translator->trans('text.notification.product_translation', [
    ...
    public function notifyReviewers(ProductInterface $product)
    {
        ...
        $this->notifyUsers($this->translator->trans('text.notification.product_review', [
            '%PRODUCT_NAME%' => $product->getName(),
        ]), $product, $users);
    }
    ...
    public function notifyPublishers(ProductInterface $product)
    {
        ...
        $this->notifyUsers($this->translator->trans('text.notification.product_publication', [
            '%PRODUCT_NAME%' => $product->getName(),
        ]), $product, $users);
    }
