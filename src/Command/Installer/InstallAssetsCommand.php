...
class InstallAssetsCommand extends AbstractInstallCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Installs all Jedisjeux assets.')
            ->setHelp(<<<EOT
The <info>%command.name%</info> command downloads and installs all Jedisjeux media assets.
EOT
            )
        ;
    }
    ...
    {
        $output->writeln(sprintf('Installing Jedisjeux assets for environment <info>%s</info>.', $this->getEnvironment()));
