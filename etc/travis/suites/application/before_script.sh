...
print_header "Configuring parameters" "Jedisjeux"
...
print_header "Setting the application up" "Jedisjeux"
...
run_command "bin/console ckeditor:install --env=test --no-debug -vvv" || exit $?
