...
Feature: Workflow jedizone
  ...
  ## Status WRITING
  ###################
  Scenario: Affichage de la fiche de jeu en status WRITING en tant que ROLE_REDACTOR
    Given I am on "/login"
  ...
  ###################
  Scenario: Affichage de la fiche de jeu en status NEED_A_TRANSLATION en tant que ROLE_TRANSLATOR
    Given I am on "/login"
    And I fill in the following:
  ...
  ##################
  Scenario: Affichage de la fiche de jeu en status NEED_A_REVIEW en tant que ROLE_REVIEWER
    Given I am on "/login"
    And I fill in the following:
      | Nom d'utilisateur | reviewer |
      | Mot de passe      | blue |
  ...
  ##################
  Scenario: Affichage de la fiche de jeu en status READY_TO_PUBLISH en tant que ROLE_PUBLISHER
    Given I am on "/login"
    And I fill in the following:
