import './../plugins/bootstrap-notify/bootstrap-notify';
import './../plugins/isotope/isotope.pkgd.min';
import './../plugins/isotope/imagesloaded.pkgd.min';
import './../plugins/magnific-popup/jquery.magnific-popup.min';
import './../plugins/waypoints/jquery.waypoints.min';
import './../plugins/waypoints/sticky.min';
import './../plugins/countdown/jquery.countdown';
import './../plugins/countTo/jquery.countTo';
	...
	$(document).ready(function() {
		...
		if ($('html[dir="rtl"] .container-fluid .mega-menu--wide').length>0 && $(window).width() > 971) {
			(function(){
				...
				headerFirstRight = parseInt($('.header-first').offset().left + $('.header-first').outerWidth() + 15),
				megaMenuRightPosition = headerSecondRight - headerFirstRight;
				var megaMenuWidth = parseInt($('.header .container-fluid').width());
				$('.mega-menu--wide > .dropdown-menu').css('right', megaMenuRightPosition + 'px');
				$('.mega-menu--wide > .dropdown-menu').css('width', megaMenuWidth + 'px');
				$(window).resize(function() {
					var headerSecond = $('.main-navigation--mega-menu').closest('.header-second').parent(),
